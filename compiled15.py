...
def main():
    ...
    cv_acc = cross_val_score(pipeline, X_train, y_train, cv=3, scoring='accuracy', n_jobs=-1)
    ...
    plt.title('Enhanced Logistic Regression (Feature-Rich)')
    plt.show()
...
# CV Accuracy: [0.722  0.7263 0.7454] → Mean: 0.7312
